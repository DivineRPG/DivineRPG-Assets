...
<summary>PegasDoggeAM</summary>
<br>
corrupted_strength, warmth, block_protection, heavy_air, teleportation_crystal, teleportation_star, infernal_flame, aquastrive armor, frozen armor, bedrock_maul, frozen_maul, fury_maul, death_bringer, terran_maul, poison_saber, sandslash, maelstrom, shuriken, vile_storm, snowflake_shuriken, elite_realmite armor layers, creeper_pumpkin, cyclops_pumpkin, spider_pumpkin, ghast_pumpkin, ender_pumpkin, ender_watcher_pumpkin, frost_pumpkin, glacon_pumpkin, hellspider_pumpkin, jungle_spider_pumpkin, slime_light, aqua_torch, skeleton_torch, white_mushroom_plant, steel blocks, tar, Santa suit, icine_sword, sound_of_music, sound_of_carols, sound_of_whales, icy_stone, collector_fragments, collector, arcana keys, orb_of_light, marsine, storm_sword, arcanium_saber, livicia_sword, ender_scepter, divine_accumulator, staff_of_enrichment, ghostbane, grenade, arcanium_attractor, arcanium_reflector, captains_sparkler, arcana_portal_frame, arcanium_torch, acceleron, more dungeon_bookshelf variants, dark/star bridge, Arcana furnaces (all but demon), stained_glass variants, elevantium, eucalyptus door, firestock, hitchak_seeds, aquamarine plant, pinfly plant, eden (arrow, slicer, door, torch), wildwood (arrow, slicer, sapling), moonbulb, apalachia (log_side, stripped_log_side, log_top, stripped_log_top, leaves, sapling, tallgrass), pink/purple glowbone, dusk_bloom, dusk_flower, skythern (slicer, planks, log_side, stripped_log_side, log_top, stripped_log_top, leaves, sapling), sky_flower, fury_arrow, halite (slicer, phaser, blitz), band_of_lheiva_hunting, miners_amulet, dream_dirt, mintwood (log_side, stripped_log_side, log_top, stripped_log_top, leaves), dreamwood log/leaves, acid blocks, lunic_altar, weedwood vines, vethea_portal
</details>
