...
<summary>PegasDoggeAM</summary>
<br>
coalstone_furnace (GUI), arcanite_stone, cobbled_frozen_stone, frosted_allure (all modes), icy_bricks, crate, plank_design, fancy_wool, rainbow_wool, tomato_plant (all 8 stages), bacon, empowered_meat, raw_empowered_meat, tomato_seeds, shiverspine_door (item), ender_arrow, snowstorm_arrow, soulfire_arrow, ender_bow (all 4 states), hunter_bow (all 4 states), icicle_bow (all 4 states), shadow_bow (all 4 states), snowstorm_bow (all 4 states), soulfire_bow (all 4 states), scythe, cyclopsian_staff, cyclopsian_sword, crabclaw_maul, aquatic_trident, aquaton, aquatic_maul
</details>
