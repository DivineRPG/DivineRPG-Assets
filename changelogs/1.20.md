...
- Melee weapon stats rebalance (except for Vethea)
- Tool stats rebalance
...
<summary>PegasDoggeAM</summary>
<br>
eden_dust, eden_sparkles, eden_fragments, eden_gem, eden_chunk, eden_soul, eden tools, eden_blade, eden_slicer, wildwood tools, wildwood_blade, olivine, oxdrite_ingot, raw_oxdrite, call_of_the_watcher, horde_horn, twilight_clock, livestock_pet_spawn_egg, zelus_pet_spawn_egg, aquamarine, aquamarine_seeds, dream_carrot, frost_sword, frostking_sword, elite realmite armor (only items), raw_oxdrite_block, oxdrite_block, oxdrite_ore, cobaltite, polished_cobaltite, divine_moss_stone, eden_brush, eden_sapling, eden_grass_side, eden_grass_top, eden_log_top, stripped_eden_log_side, stripped_eden_log_top, eden_planks, eden_portal, glaciline, different lamps, olivine_block, budding_olivine, olivine_cluster, auroraoak_door_top, auroraoak_door_bottom, auroraoak_door, auroraoak_trapdoor, stripped_cozybark_log_side, stripped_cozybark_log_top, cozybark_door, stripped_streamleaf_log_side, stripped_streamleaf_log_top, streamleaf_door, steel (all colors), fairy_lights (all colors), candy_cane (all colors), asphalt, dungeon_air, spike_block (both variants), zombie_pumpkin/skeleton_pumpkin (all sides), crimpetal, globebrush (top/bottom), thermoliage (top/bottom), winterbloom, wisp_leaf, steel_door (top/bottom/item), icy_stone, present_box, glowsprout_stem_side, glowsprout_stem_top, lowsprout_stem_side, lowsprout_stem_top, slowsprout_stem_side, slowsprout_stem_top, frozen_dirt, frozen_grass_top, frozen_grass_top_overlay, frozen_grass_side, frozen_grass_side_overlay, vane (all variants), different bricks, firewood blocks, milk_stone, altar of corruption, darkstone, hungerstone (both), dream_dirt (+4 grass blocks), dream_stone, everstone (all 3), fire_crystal, firelight, luna_stone, smooth_glass, apalachia_dirt, apalachia_grass (top/side), wildwood_dirt, wildwood_grass (top/side), barred_door (top/bottom/item), bulbatobe, cracklespike, dreamglow, fernite, dulah (both), gemtop (both), heliotic_beam, hive_egg, karos_heat_tile (both), shimmer, shine_grass, dream_cake, dream_melon, dream_pie, dream_sours, dream_sweets, rock_chunks, moon_bud, moonlight_fern, wildwood tree blocks, wildwood tallgrass, wildwood_vine, corrupted tools, oxdrite_pickaxe, glacier_sword, slime_sword, icicle_bane, hitchak (+seeds), mysterious_clock, skythern_dust, skythern_fragments, skythern_soul, skythern_gem, skythern_chunk, wildwood_dust, wildwood_fragments, wildwood_soul, wildwood_gem, wildwood_chunk, pinfly (+seeds), arcana doors, ancient_stone, soul_stone, soul_sludge, ancient_tile, arcana_bush, arcanite vines, arcanite_moss, arcanite grass (+dirt), arcanite_ladder, arcanium_metal, arcanium_power, arcanium_rich_sand, raw_arcanium, dungeon_bookshelf, gem_of_the_dunes, arcana_brush, arcanite_tubes, piece_of_raw_arcanium, scythe, glacial_wall_totem, icicle_dagger, cauldron_flesh
</details>
