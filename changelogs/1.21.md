...
- Increased the size of some weapon models (staves, crabclaw maul)
...
- Cooked Bacon
- Corail Woodcutter recipes compat
- Dye recipes for two flowers that used to have dust recipes
- Effects for some foods
- Eggnog causes Mining Fatigue and Slowness for 12 seconds
...
- JEED recipes compat (+updated effect descriptions)
- Jungle Spiders became poisonous
- More fuels (coalstone, tar, blubber, etc.)
- More info for some items (JEI compat)
- New music ("Cold Waters" by 3DA)
- ProjectE recipes compat (+EMC tweaks)
- Recipes for Candy Canes, Chocolate Logs and Snow Cones
