...
- Wildwood Tomo model (SirDeccy)

**Additions:**
- Now shurikens drop if they hit Endermen
- Smelting recipes for some equipment

**Fixes:**
- Fixed AI for merchants
- Fixed Endermen getting effects from non-magic projectiles
- Fixed full Jack O'Man set Scythe damage
- Fixed Horde Horn crash
- Fixed Icicle Arrows freezing freeze-immune mobs
- Fixed magic projectile stats/knockback issues
- Fixed Twilight Demon attacking the player in Creative
- Fixed harps not inflicting magic damage
- Jack O'Man no longer despawns when far away
- Jungle Spiders no longer spawn on bedrock
- Some Damage Type tag tweaks
- Some Firestock tweaks (now you can throw a full stack at once)
